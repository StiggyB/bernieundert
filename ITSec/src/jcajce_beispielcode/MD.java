...
/*
 * In diesem Beispiel wird der Message Digest für eine Datei berechnet
 * und angezeigt.
 * Der Algorithmus für die kryptographische Hashfunktion (z.B. "SHA1" oder "MD5")
...
public class MD
{
  ...
  {
	// b ist mit Einsen auf 4 Byte (Wort) aufgefüllt
