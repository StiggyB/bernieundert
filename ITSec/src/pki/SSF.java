 ...
 * 
 * Syntax:
 * 	deprecated: java SSF KMueller.prv FMeier.pub Brief.doc Brief.ssf
 *	All in/out files can be choosen via a file chooser  
 * 
 * @author Martin
 */
public class SSF extends SFHelper{
	 ...
	 * generate AES key
	 * 
	 * @param size length for AES algorithm in bits
     ...
     * 
     * @param k private RSA key to use 
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            // 2c) AES Key (128 Bit) erstellen (siehe JCA/JCE: CipherEncryption.java)
