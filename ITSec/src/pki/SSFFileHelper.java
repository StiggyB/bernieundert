...
public class SSFFileHelper {
	...
	/**
	 * Set FileInputStream for ssf-file with position where crypted data starts
	 * 
	 * @param fis
	 *            use FileInputStream for ssf-file
	 */
	...
	/**
	 * extract AES key and signature, set FileInputStream to position, where
	 * crypted data starts in ssf-file
	 * 
	 * @param file
	 *            choosen ssf-file
