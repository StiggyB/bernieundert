 ...
 * 
 * Syntax:
 * 	deprecated: java RSF FMeier.prv KMueller.pub Brief.ssf Brief.doc
...
public class RSF extends SFHelper {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Verifikation der Signatur verlief erfolgreich: "+sign.verify(ssfFile.getSecretKeySignature()));            
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
