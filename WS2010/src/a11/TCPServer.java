...
public class TCPServer {
	 ...
	 * @param args Derzeit keine Funktion, man könnte hier (bei verschiedenen IPs/NICs) Bind-Adresse und Wunschport übergeben.
	 * Bspw: args[0] bindadresse und args[1] serverport
	 */
		...
		try {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					//Möglichkeit, den Server gezielt in einen bestimmten STATE zu setzen
					while (true) {
...
//			Darüber koennte man abfragen, wieviele Threads derzeit laufen und wieviele noch
//			gestartet werden können, bevor der Server dann in den STATE: BUSY übergeht,
