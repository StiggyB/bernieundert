...
/**
 * Der ObjectHolder enthält ein zu inspizierendes Objekt und implementiert
 * Runnable, so können wir den Vorgang als Thread laufen lassen. in der run()
 * Methode ändern wir laufend den Wert einer Variablen, allerdings müssen wir
 * vorher prüfen, ob es sich um unser Testobjekt der DummyClass handelt. Unser
 * ObjectHolder ruft die objectChanged() Methode bei einer Objektänderung auf
 * und der Tree wird neu aufgebaut. So kriegen wir die Änderungen mit und im
 * Browser angezeigt. Das gilt in unserem Beispiel aber nur statisch für ein
