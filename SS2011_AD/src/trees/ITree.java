...
public interface ITree <E>{
	...
	//**********************************************************************
	// getHeight() liefert die Höhe des Baumes
	//**********************************************************************
	public int getHeight();
	
	//**********************************************************************
	// preOrderTraverse() liefert eine Stringrepräsentation der Elemente
	...
	//**********************************************************************
	// postOrderTraverse() liefert eine Stringrepräsentation der Elemente
	...
	//**********************************************************************
	// levelOrderTraverse() liefert eine Stringrepräsentation der Elemente
