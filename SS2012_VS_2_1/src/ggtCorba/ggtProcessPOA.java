 ...
 implements ggtCorba.ggtProcessOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getStartValue", new java.lang.Integer (6));
  }
  ...
  // Name/ID des Prozess im Konstruktor
       ...
       case 3:  // ggtCorba/ggtProcess/terminate
       {
         ...
         boolean isAllowed = in.read_boolean ();
         this.terminate (processName, isAllowed);
         out = $rh.createReply();
         break;
       }
       ...
       case 6:  // ggtCorba/ggtProcess/getStartValue
       {
         int $result = (int)0;
         $result = this.getStartValue ();
         out = $rh.createReply();
