...
public class _CoordinatorStub extends org.omg.CORBA.portable.ObjectImpl implements ggt.Coordinator
{
  ...
  public void start (int minProcess, int maxProcess, int minDelay, int maxDelay, int timeout, int ggt, monitor.Monitor mntr)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void registerProcess (ggt.ggtProcess process, String processName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void unregisterStarter (ggt.Starter starter) throws ggt.CoordinatorPackage.starterDoesNotExists
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:ggt/Coordinator/starterDoesNotExists:1.0"))
                    throw ggt.CoordinatorPackage.starterDoesNotExistsHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public void processCalcDone (ggt.ggtProcess process)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
