...
/**
* ggt/_ggtProcessStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ggt.idl
* Freitag, 27. April 2012 10:45 Uhr MESZ
*/

public class _ggtProcessStub extends org.omg.CORBA.portable.ObjectImpl implements ggt.ggtProcess
{


  // Name/ID des Prozess im Konstruktor
  public void initProcess (ggt.ggtProcess left, ggt.ggtProcess right, int startValue, int delay, int timeout, monitor.Monitor mntr)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("initProcess", true);
                ggt.ggtProcessHelper.write ($out, left);
                ggt.ggtProcessHelper.write ($out, right);
